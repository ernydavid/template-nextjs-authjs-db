...
import { CalendarIcon, CircleDollarSignIcon, FileBadge, FileBadgeIcon, PlusIcon } from 'lucide-react'
...
interface NewEmployeeContractsDialogProps {
  employeeId: string
}

export function NewEmployeeContractsDialog ({ employeeId }: NewEmployeeContractsDialogProps) {
  ...
  const form = useForm<z.infer<typeof EmployeeContractsSchema>>({
    ...
    defaultValues: {
      ...
      contractType: 'fixed-term' || undefined
    }
  })
    ...
    >
      ...
      <DialogContent className='md:max-w-[600px] h-full md:h-auto overflow-y-auto md:overflow-hidden'>
        <DialogHeader>
          ...
          <DialogDescription>
            Add, update or delete employee contract information.
          </DialogDescription>
        </DialogHeader>
